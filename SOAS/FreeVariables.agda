...
module _ where
  ...
  mvarThing ∅ ε = []
  mvarThing {𝔐}{τ} (α ∙ Γ) ε = (ε new) ++ mvarThing {𝔐}{τ} Γ (λ v → ε (old v))
...
module _ where
  ...
  mcontract¹ [] = []
  mcontract¹ {𝔐}{τ}{α}{Γ}{Ψ} ((_ , _ , ↓) ∷ xs) = mcontract¹ {𝔐}{τ}{α}{Γ}{Ψ} xs
  mcontract¹ {𝔐}{τ}{α}{Γ}{Ψ} ((β , Δ , ↑ snd) ∷ xs) = (β , Δ , snd) ∷ (mcontract¹ {𝔐}{τ}{α}{Γ}{Ψ} xs)
